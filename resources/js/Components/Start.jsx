...
return (
  <section className="section flex flex-col items-center mt-20 justify-center sm:flex-row flex-col" id="Start">
  <div className="flex flex-col items-center justify-between flex-grow max-w-6xl">
    ...
    >
      ...
      <div className="ml-4 font-medium text-lg transition duration-500 transform hover:scale-105">
        <h1 className="text-2xl font-semibold text-blue-500">Make a CV according to ATS Friendly</h1>
        <p className="py-4 max-w-md">
          This website helps you create a suitable and friendly CV that has become a company standard for recruiting.
        </p>
      </div>
    </motion.div>
